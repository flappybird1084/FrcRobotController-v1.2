...
public class AprilTagPIDReading {
    ...
    public AprilTagPIDReading(double pidX, double pidZ, double pidYaw, double metersX, double metersY) {
        this.pidX = pidX;
        this.pidZ = pidZ;
        this.pidYaw = pidYaw;
    ...
    public static AprilTagPIDReading decompress(DatagramPacket packet) {
        double pidX = 0.0, pidZ = 0.0, pidYaw = 0.0, metersX = 0.0, metersY = 0.0;
        ...
        return new AprilTagPIDReading(pidX, pidZ, pidYaw, metersX, metersY);
    }
    ...
    public String toString() {
        return "PIDReading [pidX=" + pidX + ", pidZ=" + pidZ + ", pidYaw=" + pidYaw + "]";
    }
}
